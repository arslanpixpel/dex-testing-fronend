...
import useCCDWalletStore from "../store/ccd-wallet/ccdWalletStore";
...
const isNetworkMatchNew = async () => {
  ...
  if (provider.getSelectedChain === undefined) {
...
const useCCDWallet = () => {
  ...
  const hasNewApi = provider?.getSelectedChain !== undefined;
