...
const transactionCosts = {
  eth: {
    rootManagerDepositOverheadGas: ensureDefined(
      process.env.REACT_APP_ROOT_MANAGER_DEPOSIT_OVERHEAD_GAS,
    ...
    rootManagerWithdrawErc20Gas: ensureDefined(
      process.env.REACT_APP_ROOT_MANAGER_WITHDRAW_ERC20_GAS,
    ...
    rootManagerWithdrawEthGas: ensureDefined(
      process.env.REACT_APP_ROOT_MANAGER_WITHDRAW_ETH_GAS,
  ...
  ccd: {
    bridgeManagerWithdrawEnergy: ensureDefined(
      process.env.REACT_APP_BRIDGE_MANAGER_WITHDRAW_ENERGY,
