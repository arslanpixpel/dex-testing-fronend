      ...
      <div className="flex justify-between gap-5">
        ...
        <div className="flex flex-col bg-app-black rounded-lg px-5 py-8 w-1/3 h-max">
          ...
          <div className="flex justify-center ">
            <div className="px-5 py-2 w-max bg-app-blue rounded-lg font-medium text-lg">APPLY</div>
          </div>
        </div>
        <div className="flex flex-col bg-app-black rounded-lg px-5 py-8 w-1/3 h-max">
          <div className="flex justify-center mb-14">
          ...
          <div className="flex justify-center ">
            <div className="px-5 py-2 w-max bg-app-green rounded-lg font-medium">APPLY</div>
          </div>
        </div>
      </div>
    </div>
