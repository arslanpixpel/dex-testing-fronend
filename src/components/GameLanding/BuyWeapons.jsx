    ...
    <div className="flex sm:flex-row flex-col 2xl:py-24 xl:py-20 lg:py-16 md:py-12 sm:py-9 py-5 bg-app-black sm:gap-0 gap-3">
      ...
      <div className="flex flex-col justify-center 2xl:gap-10 xl:gap-8 lg:gap-6 md:gap-3 gap-2 sm:w-1/2 w-full 2xl:px-32 xl:px-24 lg:px-16 md:px-8 px-3">
        ...
        <div className="text-gray-500 2xl:text-lg lg:text-base text-sm font-medium">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sit amet enim orci. Sed
          placerat varius lorem ultrices tincidunt. Ut eget cursus enim. Ut faucibus, orci et
          fringilla finibus, lectus augue tempor felis, ut fermentum nulla nunc ut ex. Fusce tortor
          magna, convallis quis diam eu, tempor faucibus ligula. Praesent nec elit tellus. Nam
          congue auctor ullamcorper. Donec in felis auctor nisi varius hendrerit in a nunc. Donec
          dolor leo, fermentum quis elit sed, vehicula accumsan nisi. Curabitur eget sem at est
          rutrum cursus. Suspendisse dictum tempor tincidunt. Suspendisse at felis velit. Nulla
          sodales semper justo vel tristique. Sed iaculis faucibus nibh, sit amet auctor est.
        </div>
