              ...
              return (
                ...
                >
                  <td className="py-3 px-6">
                    ...
                    <div className="text-gray-400 text-xs">{menu.title.date}</div>
                  </td>
                  <td className="px-6">
                  ...
                  <td className="px-6">
                    ...
                    <div className="text-gray-400 text-xs">{menu.title.Price_under}</div>
                  </td>
                  <td className="px-6">
                    <div>{menu.title.Total}</div>
                    <div className="text-gray-400 text-xs">{menu.title.TotalPercent}</div>
                  </td>
                  <td className="px-6">
